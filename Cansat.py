    ...
    try:
        while 1:
                            ...
                            if label is not None:
                                ...
                                if (GPGGA_data_available > 0):
                                    GPGGA_buffer = received_data.split("$GPGGA,", 1)[
                                        1]  # store data coming after "$GPGGA," string
                                    NMEA_buff = (GPGGA_buffer.split(','))  # store comma separated data in buffer
                                    GPS_Info()  # get time, latitude, longitude
                                    mpu_data_raw = '*,{},{},{},{},{},{},{},{},{}'.format(Gx, Gy, Gz, Ax, Ay, Az,
                                                                                         lat_in_degrees,
                                                                                         long_in_degrees, confidence)
            ...
            if (GPGGA_data_available > 0):
                ...
                mpu_data_raw = '*,{},{},{},{},{},{},{},{},{}'.format(Gx, Gy, Gz, Ax, Ay, Az, lat_in_degrees,
                                                                                         long_in_degrees, detected)
                front_key = bytearray([0x76,0x00,0x60,0x00])
                mpu_data_byte = mpu_data_raw.encode()
                mpu_data_bytearray = bytearray(mpu_data_byte)
                colon = bytearray(b',')
